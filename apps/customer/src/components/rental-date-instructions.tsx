  ...
  return (
    <div className="rounded-2xl border-2 border-border bg-white p-4 space-y-3">
      ...
      <div className="text-xs leading-relaxed text-muted-foreground space-y-2.5">
        ...
        <p>
          4.<strong className="text-cb-heading">หากวันใช้ชุดชิดกับคิวถัดไป</strong> ต้องส่งกลับด้วยวิธีแมส🛵ก่อน 12:00 น. ของวันถัดไป ลูกค้าออกค่าส่งเอง และต้องเว้นช่องเขียว 1 วัน (ให้ทางร้านคลีนชุด) ทั้งนี้เมื่อเช่าสำเร็จลูกค้าต้องแคปหลักฐานยืนยันกับแอดมินผ่าน Line OA ด้วย
        </p>
